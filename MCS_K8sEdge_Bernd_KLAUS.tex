...
\paragraph{EdgeMesh} As already noted, this component must be installed before it can be used. Before the actual installation, which takes place within the \ac{K8s} system, the KubeEdge configuration must be adapted.
...
wenn "ne network connect" bei KubeEdge in Frage kommt, ist ggf. KubeFed besser geeignet.
