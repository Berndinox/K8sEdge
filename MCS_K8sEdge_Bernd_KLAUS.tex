...
\begin{figure}[h]
    \centering
    \tcbox[sharp corners, boxsep=4mm, boxrule=0.2mm, colframe=gray!20!gray, colback=white]{\includegraphics[width=0.75\textwidth]{PICs/k8s-architecture.png}}
...
\begin{figure}[h]
    \centering
    \tcbox[sharp corners, boxsep=4mm, boxrule=0.2mm, colframe=gray!20!gray, colback=white]{\includegraphics[width=0.75\textwidth]{PICs/edge-overview.png}}
    \caption{edge-computing overview \cite{edge-overview}}
...
\subsection{Default}
In order to be able to manage resources at the edge, a traditional architecture can be used. This is subdivided into a centralized \textit{Control Plane} hosted in the cloud and distributed worker nodes near the edge.
...
\textcolor{red}{TODO: Picture Default}
