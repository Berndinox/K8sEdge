...
As almost all statistics and reports show, IT-Security is more important than ever \cite{stat-cyber}\cite{bsi-report-2021}\cite{report-sec-hornet} and there is no sign of this dangerous development abating\cite{sec-2022}\cite{secureops}. This makes it all the more important to always consider the IT-Security factor when setting up new environments or existing ones are expanded. The following considerations play an important role in this respect and should therefore definitely be given the necessary attention in the design phase.

TODO: CIA Triad als Basis, Verfügbarkeit und Stability haben wir schon. usw.

\paragraph{Authentication}
\paragraph{Authorization}
\paragraph{Logging} A fundamental part of the security architecture is logging.
