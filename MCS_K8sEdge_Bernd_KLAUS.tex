...
\begin{table}[ht]
    \begin{center}
        \begin{tabular}{|l|l|l|l|l|}
            ...
            \\
            installation & required tools & master/edge & \textbf{3/2} & \textbf{4/2} \\
            installation & configuration & necessary effort & \textbf{moderate} & \textbf{moderate} \\
            installation & documentation & clarity/actuality & \textbf{good} & \textbf{good} \\
            \hline
        \end{tabular}
...
\begin{table}[ht]
    \begin{center}
        ...
        \end{tabular}
        \caption{Installation complexitiy rating}
        \label{tab:poc-nodes}
    \end{center}
\end{table}
