...
When operating the enviroments
\paragraph{Stability} KubeEdge is clunky!
\paragraph{Handling} How? Differences, KnowHow!
\paragraph{Scalability} of the enviroment itself (not the deplyoment: LINK to it)
\paragraph{Troubleshooting} If shit goes wrong!

\subsection{Application deployment}
Hwo to app deploy
\paragraph{Transformation} Of the deployment or the app itself?
\paragraph{CI/CD} how?! KubeEdge ezy bezy, KubeFed NOT!
\paragraph{Deployment scaling} dynamisch scheduler vs manual
