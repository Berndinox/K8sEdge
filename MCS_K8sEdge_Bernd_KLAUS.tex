...
\end{lstlisting}
The "curl-output.txt" file defines the processing and output specifications.
        ...
        \begin{minipage}{.49\linewidth}
            \begin{center}
                \begin{tabular}{|l|l|}
                    ...
                    \hline
                \end{tabular}
                \caption{KubeEdge: curl without load}
        ...
        \begin{minipage}{.49\linewidth}
            \begin{center}
                \begin{tabular}{|l|l|}
                    ...
                    \hline
                \end{tabular}
                \caption{KubeEdge: curl with load}
                \label{tab:ke-con-noload}
            \end{center}
        \end{minipage}
    \end{center}
...
\paragraph{KubeFed}
\textit{Service respsonsenes} - A test using curl with the same parameters was carried out.
\begin{table}[ht]
    \begin{center}
        \begin{minipage}{.49\linewidth}
            \begin{center}
    ...
    \end{center}
\end{table}
The test only shows an increase of 25\%. Considering that the target node is under full load, this is an enormously good value and exceeds expectations.
