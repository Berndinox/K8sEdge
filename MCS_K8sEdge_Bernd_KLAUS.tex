...
\begin{figure}[ht]
    \centering
    \tcbox[sharp corners, boxsep=2mm, boxrule=0.2mm, colframe=gray!20!gray, colback=white]{\includegraphics[width=0.60\textwidth]{PICs/drawio/defaul-k8s.drawio.pdf}}
...
\begin{figure}[ht]
    \centering
    \tcbox[sharp corners, boxsep=2mm, boxrule=0.2mm, colframe=gray!20!gray, colback=white]{\includegraphics[width=0.60\textwidth]{PICs/drawio/distributed-k8s.drawio.pdf}}
...
\begin{enumerate}
    ...
    \begin{figure}[ht]
        \centering
        \tcbox[sharp corners, boxsep=2mm, boxrule=0.2mm, colframe=gray!20!gray, colback=white]{\includegraphics[width=0.70\textwidth]{PICs/drawio/kubefed-ressources.drawio.pdf}}
    ...
    \begin{lstlisting}[caption={Federated Object},captionpos=b]
...
w(r) must be greater than 0 and the  vcondition of validity of the value function must be fulfilled.
...
\subsection{Table}
The following table acts as a criteria catalogue. Based on the previous qualitative research using the \ac{DSR} method, the values were obtained. Due to the many different areas of application or objectives that are targeted, this table can be adapted according to one's own requirements. Following the table, this is demonstrated by way of example. There is also an empty table in the \autoref{appendix} that serves as a template.
