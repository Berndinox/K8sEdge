...
------- TODO --------
\begin{itemize}
    \item Variety - a lot different techologies / stacks
    \item Integration - different devices (arm/x64) and network topologies put together
    \item Awareness - user does not care where he is connectiong to - the application may is!
    \item Resources - are lower at the edge
    \item \ac{QoS} - Extensibility (dynamic expand), reliability, availability
    \item Security - isolation
    \item Monitoring - and accounting and metrics
\end{itemize}
